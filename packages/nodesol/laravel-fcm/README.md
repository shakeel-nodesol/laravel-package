...
To get the latest version of Laravel-FCM on your project, require it from "composer":
	...
	$ composer require nodesol/laravel-fcm
...
In your `.env` file, add the project id and the access token for the Firebase Cloud Messaging:

```php
FCM_ACCESS_TOKEN= your account token
